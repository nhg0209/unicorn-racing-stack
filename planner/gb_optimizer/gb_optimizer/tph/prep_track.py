...
def prep_track(reftrack_imp: np.ndarray,
    ...
    # Disabled: on tight F1TENTH hairpins with fine stepsize_reg the horizon=10 check always fires
    # because normals from opposite sides of the hairpin intersect within the track width.
    # The IQP/SP optimizers handle this geometry correctly without this guard.
    # (UNICORN stack disables this check for the same reason.)
