...
class ObstacleSpliner(Node):
    """
    This class implements a ROS node that splines a start trajectory ahead of the car.
    ...
    def __init__(self):
        ...
        super().__init__('start_spline_node')
    ...
    def do_spline(self, obs: Obstacle, gb_wpnts: WpntArray) -> Tuple[WpntArray, MarkerArray]:
        """
        Creates a start trajectory by splining from the current pose towards a target ahead.
